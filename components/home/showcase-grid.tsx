      ...
      <div className="flex flex-col gap-6 max-w-5xl mx-auto px-4">
        {services.map((service, i) => (
          <motion.div
            ...
            className={`bg-gradient-to-br from-[#F7F0E6] to-[#E9D8C5] border border-[#C7A47A]/50 rounded-[32px] p-8 sm:p-10 shadow-[0_4px_24px_rgba(74,52,38,0.08)] hover:shadow-[0_8px_40px_rgba(74,52,38,0.14)] will-change-transform group relative overflow-hidden ${serviceAccents[i % serviceAccents.length]}`}
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
              <div className="flex-1">
                <span className="bg-[#4A3426] text-[#F7F0E6] text-xs font-semibold px-3 py-1 rounded-full mb-4 inline-block group-hover:scale-110 transition-transform duration-300">
                  {service.index}
                </span>
                ...
                <Link href={service.href}>
                  <motion.span
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium bg-[#4A3426] text-white hover:bg-[#6B4A35] shadow-md cursor-pointer group/btn"
                  >
                    Learn more
