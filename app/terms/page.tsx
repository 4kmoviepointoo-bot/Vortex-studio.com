  ...
  return (
    <div className="min-h-screen px-4 pt-24 pb-16 bg-[#E3F2FD]">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold text-[#0D47A1] mb-8">Terms of Service</h1>
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-bold text-[#0D47A1] mt-8 mb-4">1. Acceptance of Terms</h2>
          ...
          <h2 className="text-2xl font-bold text-[#0D47A1] mt-8 mb-4">2. Services</h2>
          <p className="text-[#0D47A1]/80 mb-4">
          ...
          <h2 className="text-2xl font-bold text-[#0D47A1] mt-8 mb-4">3. Intellectual Property</h2>
          <p className="text-[#0D47A1]/80 mb-4">
          ...
          <h2 className="text-2xl font-bold text-[#0D47A1] mt-8 mb-4">4. Payment Terms</h2>
          <p className="text-[#0D47A1]/80 mb-4">
          ...
          <h2 className="text-2xl font-bold text-[#0D47A1] mt-8 mb-4">5. Limitation of Liability</h2>
          <p className="text-[#0D47A1]/80 mb-4">
          ...
          <h2 className="text-2xl font-bold text-[#0D47A1] mt-8 mb-4">6. Contact</h2>
          <p className="text-[#0D47A1]/80 mb-4">
