...
export default function AboutPage() {
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <motion.div
              ...
              className="md:col-span-2 bg-white/70 backdrop-blur-sm border border-slate-200/60 rounded-[2rem] p-8 shadow-sm hover:shadow-lg hover:border-indigo-300/60 will-change-transform group"
              style={{ transition: 'box-shadow 0.4s cubic-bezier(0.16, 1, 0.3, 1), border-color 0.4s cubic-bezier(0.16, 1, 0.3, 1)' }}
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-2xl bg-indigo-50 border border-indigo-200/60 flex items-center justify-center text-indigo-600 group-hover:scale-110 transition-transform duration-300 shrink-0">
                  {principles[0]?.icon}
                </div>
                <div>
            ...
            <motion.div
              ...
              whileHover={{ y: -4, scale: 1.01 }}
              className="bg-white/70 backdrop-blur-sm border border-slate-200/60 rounded-[2rem] p-6 shadow-sm hover:shadow-lg hover:border-cyan-300/60 will-change-transform group"
              style={{ transition: 'box-shadow 0.4s cubic-bezier(0.16, 1, 0.3, 1), border-color 0.4s cubic-bezier(0.16, 1, 0.3, 1)' }}
            >
              <div className="w-10 h-10 rounded-xl bg-cyan-50 border border-cyan-200/60 flex items-center justify-center text-cyan-600 mb-4 group-hover:scale-110 transition-transform duration-300">
                {principles[2]?.icon}
              </div>
            ...
            <motion.div
              ...
              whileHover={{ y: -4, scale: 1.01 }}
              className="md:col-span-2 bg-white/70 backdrop-blur-sm border border-slate-200/60 rounded-[2rem] p-8 shadow-sm hover:shadow-lg hover:border-violet-300/60 will-change-transform group"
              style={{ transition: 'box-shadow 0.4s cubic-bezier(0.16, 1, 0.3, 1), border-color 0.4s cubic-bezier(0.16, 1, 0.3, 1)' }}
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-2xl bg-violet-50 border border-violet-200/60 flex items-center justify-center text-violet-600 group-hover:scale-110 transition-transform duration-300 shrink-0">
                  {principles[3]?.icon}
                </div>
                <div>
      ...
      {/* Section 3: Interactive Tech Stack - Muted Warm Taupe */}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 max-w-2xl mx-auto">
              {techStack.map((tech, i) => (
                <motion.span
                  ...
                  className="px-4 py-3 rounded-xl text-sm font-medium bg-white/70 backdrop-blur-sm border border-slate-200/60 text-slate-700 hover:bg-slate-900 hover:text-white hover:border-slate-900 hover:shadow-lg will-change-transform cursor-default text-center"
