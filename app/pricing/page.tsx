        ...
        <div className="text-center mt-12">
          <Link href="/">
            <motion.span
              ...
              whileTap={{ scale: 0.94 }}
              transition={spring}
              className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-medium text-slate-600 hover:text-[#0F172A] border border-slate-200 hover:bg-slate-50 rounded-lg transition-colors cursor-pointer"
            >
              Back to Home
            </motion.span>
          </Link>
